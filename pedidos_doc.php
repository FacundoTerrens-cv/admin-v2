        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                                        ...
                                        <td>
                                            <form action="" method="post">
                                                <a class="btn btn-success" style="background-color: green" type="submit"
                                                    name="btn" value="eliminar"
                                                    href="edit_pedidos_front_doc.php?id=<?php echo $emp['id']?>">Redigere</a>
                                        </td>
                                        </form>
                                    </tr>
                                    <?php }?>
                    ...
                    <div class="card mb-4 bg-blue pb-5">
                        <div class="container">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="empleado" class="form-control" id="empleado">
                                                            <option value="">Seleccionar</option>
                                                            <option style="color:#000;" value="09:00:00-10:00:00">
                                                                09:00:00-10:00:00</option>
                                                            <option style="color:#000;" value="12:00:00-13:00:00">
                                                                12:00:00-13:00:00</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="display: none;">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="servicio" class="form-control" id="servicio">
                                                            <option value="">Seleccionar</option>
                                                            <option style="color:#000;" value="Corte de Pelo">Corte de
                                                                pelo</option>
                                                    ...
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <div class="checkbox">
                                                            <label class="text-danger"><input type="checkbox"
                                                                    name="delete"> Eliminar Evento</label>
                                                        </div>
                                                    </div>
                                                </div>
